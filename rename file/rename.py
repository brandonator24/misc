...
bad_text_list = []
new_name_list = []
default = ["gaming", "sfx", "hd", "sound effect", "soundeffect", "sound", "effect", "original", "greenscreen", "green screen", "high quality", "transparent", "official", "video", "meme", "chroma key", "free", "no copyright", "1080", "1080p"]
...
for file in os.listdir():
    ...
    if(os.path.isfile(file) == True):
        ...
        if(file_name[-1] == " "):
            stripped_name1 = file_name[:-1]
            file_name = stripped_name1
            print(f"Removed ending spaces: {file_name}")
        if(file_name[0] == " "):
            stripped_name2 = file_name[1:]
            file_name = stripped_name2
            print(f"Removed beginning spaces: {file_name}")
